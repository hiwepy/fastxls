...
public class DefaultRowMapValidationFunction<R, C, M extends RowMap> implements BiFunction<RowMapper<R, RowMap>, Integer, Set<ConstraintViolation<M>>> {
	
	@Override
	public Set<ConstraintViolation<M>> apply(RowMapper<R, RowMap> mapper, Integer rowNum) {
