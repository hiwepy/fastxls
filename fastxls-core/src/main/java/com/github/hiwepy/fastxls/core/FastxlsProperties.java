...
import com.github.hiwepy.fastxls.core.utils.ResourceUtils;

public class FastxlsProperties {
	
	protected static Logger log = LoggerFactory.getLogger(FastxlsProperties.class);
	...
	private static void init() {
		...
		try {
			properties.load(
					ResourceUtils.getResource("fastxls.properties"));
		} catch (Exception e) {
			log.warn("Couldn't find/read fastxls.properties; " + e.getMessage());
		}
	}
