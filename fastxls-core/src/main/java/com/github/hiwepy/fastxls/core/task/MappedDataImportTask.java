...
/**
 * Excel 数据导入线程（Row对象映射为Model对象，借助Validator对象进行数据行校验）
 ...
 * @param <M>
 */
public class MappedDataImportTask<W, S, R, C, M extends RowMap> implements Callable<List<RowConstraintViolation<M>>> {
