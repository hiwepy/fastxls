...
public class JXLSettings {
	...
	/**
	 * Flag to indicate whether the rationalization of cell formats is enabled. 
	...
	/**
	 * Flag to indicate whether the merged cell checking was enabled
	 */
	private boolean mergedCellChecking;

	/**
	 * Flag to indicate whether the copying of additional property sets are enabled
	 */
